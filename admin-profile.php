                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Admin Profili</strong> Güncelle
                                    </div>
...
?>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Admin Adı</label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Email Girişi</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="tckimlik" name="tckimlik" class="form-control" maxlength="11" value="<?php  echo $row['TcKimlik'];?>" required="">
                                                    
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Kullanıcı Adı</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                             ...
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Admin Kayıt Tarihi</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                        ...
                                        <p style="text-align: center;"><button type="submit" name="submit" id="submit" class="btn btn-primary btn-sm">Güncelle
                                        </button></p>
