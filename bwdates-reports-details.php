...
<h4 class="m-t-0 header-title">Tarih Aralığındaki Raporlar</h4>
                                    <?php
$fdate=$_POST['fromdate'];
$tdate=$_POST['todate'];

?>
<h5 align="center" style="color:blue"><?php echo $fdate?> den <?php echo $tdate?> tarihine kadar olan raporlar: </h5>
<hr />
